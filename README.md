...
Senders outside the trusted list can receive a reply in the conversation they
wrote from, and hold no other grant. Edit the agent ID, model and trusted
senders in `config.json`.
